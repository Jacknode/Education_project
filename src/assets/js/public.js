...
export const getTiem = (num) => {
  return toZear(parseInt(num/1200))+':'+ toZear(parseInt(num/60)) +':'+ toZear(num%60)
}
...
export const getNewStr ='http://hly.1000da.com.cn'; // '/api' //'http://192.168.3.4' //'http://192.168.3.50'
